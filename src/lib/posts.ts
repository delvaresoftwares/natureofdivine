...
export const C: Record<string, string> = {
  ...
  mountain: img('1506901777326-50aafc1b6f8a'),
  ...
  light: img('1495615080073-6b89db9839b0'),
  sea: img('1437482070675-560370fbc96e'),
  mountainLake: img('1464822759023-fed622ff2c3b'),
  dawn: img('1490604008047-b403d926b897'),
  ...
  meditation: img('1471545340021-971716f8e756'),
  ...
  gratitude: img('1513964973129-5c5f57e13f3b'),
  habit: img('1519832979513-944944b9d0e0'),
  mind: img('1507413242314-755f64fddb4a'),
  truth: img('1519389950473-47ba0277781c'),
  silence: img('1474632145216-ccc91f2bd72c'),
  soul: img('1470071459604-3b5ec3a7fe05'),
  path: img('1509316975850-ff9c5deb0cd9'),
  self: img('1494966041061-99ac4b1b0e37'),
  faith: img('1470252649378-9c29740c9fa8'),
  hope: img('1509773896268-acf7d6cc2b5f'),
  simple: img('1518531933037-91b2f5f229cc'),
  intention: img('1498038438085-5852b6ab4bc7'),
  presence: img('1454789544768-708ebf3a6227'),
  ...
  moon: img('1446941611757-91d2c3bd7d34'),
